...
export default function RegisterPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    email: "",
    password: "",
    role: "STUDENT", // Default to uppercase
  })
    ...
    <div className="min-h-screen flex items-center justify-center bg-zinc-50 dark:bg-zinc-900 p-4">
      <Card className="w-full max-w-md border-zinc-200 dark:border-zinc-800 shadow-lg dark:bg-zinc-950/50">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardDescription className="text-balance text-zinc-500 dark:text-zinc-400">Join AI Classroom and start learning</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2 relative">
              ...
              <Input
                ...
                disabled={loading}
                minLength={6}
                className="pr-10 bg-zinc-50/50 dark:bg-zinc-800/50"
              />
              <button
                type="button"
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                disabled={loading}
              >
                <SelectTrigger className="w-full bg-zinc-50/50 dark:bg-zinc-800/50">
